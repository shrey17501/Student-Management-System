...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.nic, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.nic, New With { .htmlAttributes = New With { .class = "form-control" } })
                @Html.ValidationMessageFor(Function(model) model.nic, "", New With { .class = "text-danger" })
            </div>
        </div>
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.batch_id, "batch_id", htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.DropDownList("batch_id", Nothing, htmlAttributes:= New With { .class = "form-control" })
                @Html.ValidationMessageFor(Function(model) model.batch_id, "", New With { .class = "text-danger" })
            </div>
        </div>
